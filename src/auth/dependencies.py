...
from src.models.user import Client  # O el modelo de usuario que uses
...
async def get_current_user(
  ...
  # Adjuntar el rol temporalmente al objeto
  user.role = role
  return user


def RoleChecker(allowed_roles: list[str]):
  """Middleware/Dependencia para validar si el rol del usuario tiene permisos."""
